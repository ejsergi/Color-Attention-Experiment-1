...
for i=1:length(meansvalues);
    ...
    % Selection of the specific chroma and mixing the two distribution in 
    % order to create that chroma
    ...
    % After patch distribution is created, a gausian shape location map is
    % created and then overlapped by the distribution
    ...
    % Calculation of mean and deviation for the specific patch and adding
    % it into info
